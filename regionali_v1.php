...
<html lang="en">
    ...
    <head>
        ...
        <title>Agorà TEST v1 - Dati in tempo reale sulle "Elezioni Regionali di Corigliano d'Otranto"</title>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns" id="sezioneUno">
                                            <table id="tech-companies-1" class="table  table-striped">
                                                ...
                                                <tbody>
                                                <?php 
                                                $tab_ris=mysqli_query($conn,"SELECT * FROM regionale_totale_candidati WHERE lista_appartenenza=1 ORDER BY cognome_candidato ASC");
                                                $n=mysqli_num_rows($tab_ris);
                                                for($i=0;$i<$n;++$i) {
                                                    $array=mysqli_fetch_array($tab_ris);
                                                    echo'<tr> 
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive b-0" data-pattern="priority-columns" id="sezioneUno">
                                            <table id="tech-companies-1" class="table  table-striped">
                                                ...
                                                <tbody>
                                                <?php 
                                                $tab_ris=mysqli_query($conn,"SELECT * FROM regionale_totale_candidati WHERE lista_appartenenza=2 ORDER BY cognome_candidato ASC");
                                                $n=mysqli_num_rows($tab_ris);
                                                for($i=0;$i<$n;++$i) {
                                                    $array=mysqli_fetch_array($tab_ris);
                                                    echo'<tr> 
